...
const { scene: model } = await load('/Antares.gltf')
...
onBeforeUnmount(() => {
    console.log('Antares Component is about to be unmounted, cleaning up resources...');
    cleanUpResources();
...
onUnmounted(() => {
    console.log('Antares Component unmounted.');
});
