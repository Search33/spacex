...
const { scene: model } = await load('/electron-v2.gltf')
...
onBeforeUnmount(() => {
    console.log('Electron Component is about to be unmounted, cleaning up resources...');
    cleanUpResources();
...
onUnmounted(() => {
    console.log('Electron Component unmounted.');
});
